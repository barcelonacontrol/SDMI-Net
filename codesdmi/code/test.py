...
parser.add_argument('--method', type=str,  default='XIAO_R=2', help='detail')
...
if __name__ == '__main__':
    save_mode_path = os.path.join('../model/' + args.model + '/' + args.method + '/' + args.method + '_best_model.pth')
    ...
    metric = test_calculate_metric(model, args, test_save_path=test_save_path, image_list=image_list, save_result=True)
    print(metric)
