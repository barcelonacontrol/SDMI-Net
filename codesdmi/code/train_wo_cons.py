...
# 当前运行的方法
parser.add_argument('--method', type=str, default='XIAO_WO_CONS', help='model_name')
...
if __name__ == "__main__":
    ...
    for epoch_num in tqdm(range(max_epoch), ncols=70):
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            loss = supervised_loss + 0.1 * L_rmi
            ...
            logging.info('iteration %d : loss : %f , lsup: %f , lr: %f' % (
            iter_num, loss.item(), supervised_loss.item(), lr_))
